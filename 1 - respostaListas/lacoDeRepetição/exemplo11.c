...
int main()
{
    int num_dec, unidade_dec, dezena_dec, centena_dec, milhar_dec;
    char num_romano[15];
    char unidade_romano[10][4] = {"", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX"};
    char dezena_romano[10][4] = {"", "X", "XX", "XXX", "XL", "L", "LX", "LXX", "LXXX", "XC"};
    char centena_romano[10][4] = {"", "C", "CC", "CCC", "CD", "D", "DC", "DCC", "DCCC", "CM"};
    char milhar_romano[10][3] = {"", "M", "MM", "MMM"};
